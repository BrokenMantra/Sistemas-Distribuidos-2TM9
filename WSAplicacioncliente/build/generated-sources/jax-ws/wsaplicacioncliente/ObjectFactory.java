 ...
 * generated in the wsaplicacioncliente package. 
...
public class ObjectFactory {
    ...
    private final static QName _Comprar_QNAME = new QName("http://Transaccion.me.org/", "Comprar");
    private final static QName _ComprarResponse_QNAME = new QName("http://Transaccion.me.org/", "ComprarResponse");
    private final static QName _Pagar_QNAME = new QName("http://Transaccion.me.org/", "Pagar");
    private final static QName _PagarResponse_QNAME = new QName("http://Transaccion.me.org/", "PagarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wsaplicacioncliente
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://Transaccion.me.org/", name = "Comprar")
     ...
     */
    @XmlElementDecl(namespace = "http://Transaccion.me.org/", name = "ComprarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://Transaccion.me.org/", name = "Pagar")
     ...
     */
    @XmlElementDecl(namespace = "http://Transaccion.me.org/", name = "PagarResponse")
